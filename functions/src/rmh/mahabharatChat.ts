...
/**
 * Cloud Function to handle chat interactions related to the Mahabharat.
 *
 * This function receives a message from a user, processes it using Google Generative AI,
 * and returns a response with synthesized speech. The response is based on the Mahabharat.
 *
